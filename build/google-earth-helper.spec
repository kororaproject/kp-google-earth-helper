...
License:	GPLv3+
BuildArch:	noarch
Requires:	redhat-lsb(x86-32) redhat-lsb-desktop(x86-32) cracklib(x86-32) db4(x86-32) libxml2(x86-32) libXt(x86-32) glib2(x86-32) mesa-libGLU(x86-32) nspr(x86-32) nss(x86-32) nss-softokn(x86-32) nss-util(x86-32) pam(x86-32) qt3(x86-32) 
...
%changelog
* Sat Aug 04 2012 Chris Smart <chris@kororaa.org> 0.1-2
- Fixed dependencies for redhat-lsb-graphics which is now supplied by redhat-lsb-desktop.
